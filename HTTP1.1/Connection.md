...
PUT方法请求将所包含的实体存储在提供的Request-URI下，通过该方法客户端可以将指定资源的最新数据传送给服务器取代指定的资源的内容
* 如果Request-URI指向已存在的资源，则请求实体应该被视为驻留在源服务器上实体的修改版本
* 如果对应的Request-URI不存在，则源服务器可以为该URI创建资源